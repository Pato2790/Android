...
public class DrawerNavActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(this instanceof MainActivity) {
            ...
            actividad=0;
            Log.d("sss","main");
        }else if(this instanceof ShowViajeActivity) {
            Log.d("sss", "show");
            actividad=1;
        ...
        if (user != null) {
            ...
            //Drawable b= downloadImage("https://lh6.googleusercontent.com/-ePC_b10hXgA/AAAAAAAAAAI/AAAAAAAAAf0/J-j5E5TjhZs/s96-c/photo.jpg");
            //("https://lh6.googleusercontent.com/-ePC_b10hXgA/AAAAAAAAAAI/AAAAAAAAAf0/J-j5E5TjhZs/s96-c/photo.jpg");
    ...
    private void ViajeCreados(){
        if (actividad==0) {
            Intent SV = new Intent(DrawerNavActivity.this, MisViajesActivity.class);
            SV.putExtra("tipo", 1);
            startActivity(SV);
        }
        else {
    ...
    private void buscarViaje(){
        if (actividad==0) {
            Intent SV = new Intent(DrawerNavActivity.this, MainActivity.class);
        }
        else {
            Intent SV = new Intent(DrawerNavActivity.this, MainActivity.class);
            startActivity(SV);
